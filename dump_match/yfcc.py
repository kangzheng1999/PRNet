...
parser.add_argument('--raw_data_path', type=str, default='/home/kz/dataset/yfcc/raw_data/',
                    help='raw data path. default:../raw_data/')
parser.add_argument('--dump_dir', type=str, default='/home/kz/dataset/yfcc/data_dump/',
...
if __name__ == "__main__":
    ...
    yfcc_te = Dataset(config.raw_data_path + 'yfcc100m', config.dump_dir, 'yfcc-' + config.desc_name + '-test18-34.hdf5', \
    ...
    yfcc_tr_va = Dataset(config.raw_data_path + 'yfcc100m', config.dump_dir,
                         'yfcc-' + config.desc_name + '-val18-34.hdf5', \
                         train_seqs, 'val', config.desc_name, \
                         config.vis_th, 100, None)
    yfcc_tr_tr = Dataset(config.raw_data_path + 'yfcc100m', config.dump_dir,
                         'yfcc-' + config.desc_name + '-train18-34.hdf5', \
