...
data_arg.add_argument(
    "--data_tr", type=str, default='/home/kz/dataset/yfcc/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='/home/kz/dataset/yfcc/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='/home/kz/dataset/yfcc/yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    "--log_suffix", type=str, default="prnet", help=""
    "suffix of log dir")
train_arg.add_argument(
